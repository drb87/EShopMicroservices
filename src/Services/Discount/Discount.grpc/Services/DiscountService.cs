    ...
    : DiscountProtoService.DiscountProtoServiceBase
{
    ...
    public override async Task<CouponModel> CreateDiscount(CreateDiscountRequest request, ServerCallContext context)
    {
        ...
        if (coupon is null)
            throw new RpcException(new Status(StatusCode.InvalidArgument, "Invlaid request object."));

        dbContext.Coupons.Add(coupon);
        await dbContext.SaveChangesAsync();

        logger.LogInformation("Discount is sucesfully created. ProductName : {ProductName}", coupon.ProductName);
    ...
    public override async Task<CouponModel> UpdateDiscount(UpdateDiscountRequest request, ServerCallContext context)
    {
        ...
        logger.LogInformation("Discount is sucesfully updated. ProductName : {ProductName}", coupon.ProductName);
